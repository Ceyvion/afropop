      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {data.image ? (
          <img 
            src={data.image} 
            alt={data.title} 
            className="aspect-video rounded-xl mb-10 object-cover w-full"
            onError={(e) => {
              const target = e.target as HTMLImageElement;
              target.onerror = null;
              target.parentElement!.innerHTML = '<div class=\"bg-gray-200 border-2 border-dashed aspect-video rounded-xl mb-10\"></div>';
            }}
          />
        ) : (
