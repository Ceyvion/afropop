                ...
                <div className="p-6 space-y-5">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex space-x-3">
                      <Link href="/community" className="text-white/60 hover:text-white transition-colors duration-200">
                    ...
                    <Link href="/episodes" className="text-xs uppercase tracking-[0.35em] text-accent-v hover:text-white transition">
                      View Episodes
                    </Link>
                  </div>
                </div>
